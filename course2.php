					...
					<section id="testimornial-area">
						<div class="container">
							<div class="row">
								<div class="col-lg-12">
									<div class="tm-box">
										<img src="img/crses/bg_android.jpg" alt="Image" class="img-responsive">
										<div class="tm-box-description">
											<h2 class="ex2">Android Development Course</h2>
											<p class="tm-box-p">Android Programming lets you create stuff that's meaningful . And that's what we focus on ! 
                                            </p>
											<p class="tm-box-p">Any programming language is just another language unless you learn it the right way. A programmer can not benefit from its features if she/he does not appreciate a Programming Language's core concepts.

                                                Being an open source platform, it is very important to learn how to solve the problems taking help from other Android Developers. During the course , we guide students how to be not just a programmer but be an active participant in the Android Open Source Community !<br><br>
                                                What you’ll learn<br>
                                                <ul>
                                                    <li>Get a firm grip on Android Programming.</li>
                                                    <li>Learn to Find solutions to any problem related to Android Programming.</li>
                                                    <li>Appreciate the power of Open Source !</li>
                                                </ul><br>
                                                ...
                                                <ul>
                                                   <li> Got an idea and what to give it the shape of an Android App ! Most Welcome :)
                                                    Enjoy Coding? Join us !!</li></ul></p><br>
