					...
					<section id="testimornial-area">
						<div class="container">
							<div class="row">
								<div class="col-lg-12">
									<div class="tm-box">
										<img src="img/crses/bg_web.png" alt="Image" class="img-responsive">
										<div class="tm-box-description">
											<h2 class="ex2">Web Development Course</h2>
											<p class="tm-box-p">When you make the positive decision to enroll in the course, you will be professionally instructed on how to create a professionally optimized website in terms of design, SEO and security. The same process I've used to create websites that make thousands of dollars in passive income.
											</p>
											<p class="tm-box-p">By then end of this course, you will learn how to setup your own WordPress website the right way, with the best back end settings for SEO, security, email marketing with all the little details of designing a website covered.
												<br><br>
												What you’ll learn<br>
												<ul>
													<li>Create a Website With the Twenty Twenty theme From Step 1 To Step Done in 2 Hours</li>
													<li>Find out what essential plugins you'll need for your WordPress website.</li>
													<li>Learn how to optimize your on page SEO.</li>
													<li>Learn what the best back end settings are for a WordPress powered website.</li></ul><br>
												
												Are there any course requirements or prerequisites?<br>
												<ul>
													<li>You will need access to the internet.</li>
													<li>Be willing to buy essential services like a web hosting account and a domain name.</li>
												</ul>
												Who this course is for:<br>
												<ul>
													<li>Anyone who is looking to get started with blogging and building their online presence</li></ul>
												</p><br>
											<a href="courseapply.html" class="feature-content-link green-btn">Apply Now</a>    
										</div>                        
									</div>                    
								</div>
							</div>
