					...
					<section id="testimornial-area">
						<div class="container">
							<div class="row">
								<div class="col-lg-12">
									<div class="tm-box">
										<img src="img/crses/bg_selenium.jpg" alt="Image" class="img-responsive">
										<div class="tm-box-description">
											<h2 class="ex2">Selenium Test Automation Course</h2>
											<p class="tm-box-p">
                                                
                                            Are you new to testing automation?<br>

                                            Are you short of time to study?<br>

                                            Are you looking for a simple and fast way to implement your first automated testing environment?
                                            </p>
											<p class="tm-box-p">
                                                ***** IF YOU ANSWERED YES FOR ALL THESE QUESTIONS, THEN THAT COURSE IS FOR YOU! *****<br><br>


                                                    Complete, free solution to automate functional testing<br>

                                                    Developed by professionals from large companies (Google, Facebook, Mozilla, Opera), Selenium is one of the best alternatives for those who want to automate functional testing of web projects. It is no wonder that it was adopted as the main technology of testing in Cloud (Testing Cloud) of famous companies of the branch such as: BrowserStack, SauceLabs and CrossBrowserTesting.<br><br>
                                                    ...
                                                    <ul><li>
                                                        Use the Selenium IDE to create an automated test suite for web aplications.
                                                    </li></ul><br>
                                                    ...
                                                    <ul><li>
                                                        Students and professionals who are looking for a simple way to enter the world of Test Automation.
                                                    </li></ul><br>
                                                    </p>
